...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('package_package', 'pypi_url')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Package.pypi_url'
        db.add_column('package_package', 'pypi_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)
